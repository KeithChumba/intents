package com.example.augustmidmorningintentsandlists
...
import com.example.augustmidmorningintentsandlists.ui.theme.AugustMidMorningIntentsAndListsTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AugustMidMorningIntentsAndListsTheme {
...
fun Myintents() {
    Column(modifier = Modifier
        ...
        Row(modifier = Modifier
            ...
            Button(onClick = {
                val uri = Uri.parse("smsto:07000000")
            ...
            Button(onClick = {
                ...
                emailIntent.putExtra(Intent.EXTRA_TEXT, "Dear Sir, following your...")
        ...
        Row(modifier = Modifier
            ...
            Button(onClick = {
                ...
                if (ContextCompat.checkSelfPermission(context, android.
